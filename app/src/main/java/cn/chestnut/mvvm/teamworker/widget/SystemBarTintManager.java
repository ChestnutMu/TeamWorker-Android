...
public class SystemBarTintManager
{
    ...
    public static class SystemBarConfig {
        ...
        private float mSmallestWidthDp=0;
        ...
        /**
         *
         * Should a navigation bar appear at the bottom of the screen in the current  * device configuration? A navigation bar may appear on the right side of  
