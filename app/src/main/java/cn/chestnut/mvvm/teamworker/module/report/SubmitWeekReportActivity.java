...
public class SubmitWeekReportActivity extends BaseActivity {

    private ActivitySubmitWeekReportBinding binding;
    ...
    protected void addContainerView(ViewGroup viewGroup, LayoutInflater inflater) {
        binding = DataBindingUtil.inflate(inflater, R.layout.activity_submit_week_report, viewGroup, true);
        initData();
        addListener();
    }
    ...
    protected void addListener() {
        binding.ivPicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                processPhotoUtils = new ProcessPhotoUtils(SubmitWeekReportActivity.this);
        ...
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (StringUtil.isStringNotNull(binding.etFinishedWork.getText().toString())
                    ...
                    public void complete(String key, ResponseInfo info, JSONObject res) {
                        ...
                        if (info.isOK()) {
                            ...
                            try {
                                ...
                                showToast("图片上传成功");
                                GlideLoader.displayImage(SubmitWeekReportActivity.this, filePath, binding.ivPicture);
    ...
    private void submitReport() {
        ...
        showProgressDialog(this);
        RequestManager.getInstance(this).executeRequest(HttpUrls.SUBMIT_WEEK_REPORT, params, new AppCallBack<ApiResponse<Object>>() {
            @Override
