...
import cn.chestnut.mvvm.teamworker.databinding.ActivitySubmitDayReportBinding;
...
public class SubmitDayReportActivity extends BaseActivity {

    private ActivitySubmitDayReportBinding binding;
    ...
    protected void addContainerView(ViewGroup viewGroup, LayoutInflater inflater) {
        binding = DataBindingUtil.inflate(inflater, R.layout.activity_submit_day_report, viewGroup, true);
        initData();
        addListener();
    }
    ...
    protected void addListener() {
        binding.ivPicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                processPhotoUtils = new ProcessPhotoUtils(SubmitDayReportActivity.this);
                    ...
                    public void complete(String key, ResponseInfo info, JSONObject res) {
                        ...
                        if (info.isOK()) {
                            ...
                            try {
                                ...
                                showToast("图片上传成功");
                                GlideLoader.displayImage(SubmitDayReportActivity.this, filePath, binding.ivPicture);
    ...
    private void submitReport() {
        ...
        params.put("unfinishedWork", binding.etUnfinishedWork.getText().toString());
        ...
        showProgressDialog(this);
        RequestManager.getInstance(this).executeRequest(HttpUrls.SUBMIT_DAY_REPORT, params, new AppCallBack<ApiResponse<Object>>() {
            @Override
