    ...
    protected void addListener() {
        ...
        adapter.setOnPunchPhotoClickListener(new AttendanceAdapter.OnPunchPhotoClickListener() {
            ...
            public void onPunchInPhotoClick(int position) {
                Intent intent = new Intent(CheckAttendanceActivity.this, PhotoActivity.class);
                    ...
                    public void complete(String key, ResponseInfo info, JSONObject res) {
                        ...
                        if (info.isOK()) {
                            ...
                            try {
                                ...
                                GlideLoader.displayImage(CheckAttendanceActivity.this, filePath, binding.ivPicture);
                                showToast("图片上传成功");
