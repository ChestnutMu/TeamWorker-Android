...
#######################     常用第三方模块的混淆选项         ###################################
## 自定义组件
-keep class cn.chestnut.mvvm.teamworker.widget.** { *; }
...
-keepattributes Signature
-keepattributes *Annotation*
-keep class com.squareup.http.** { *; }
-keep interface com.squareup.http.** { *; }
-dontwarn com.squareup.http.**
...
-keep class cn.chestnut.mvvm.teamworker.model.** { *; }
-keep class cn.chestnut.mvvm.teamworker.http.ApiResponse { *; }
